...
export const AuthProvider = ({ children }) => {
  ...
  const [isDBNotificationsViewExecuted, setIsDBNotificationsViewExecuted] = useState(false);
  ...
  const login = async (username, password, companyId = null) => {
    try {
      ...
      const groups = typeof user.groups === 'string' ? JSON.parse(user.groups) : user.groups;
