...
const CalendarIntegration = ({
  ...
  const handleRemoveFromCalendar = async () => {
    if (
      !window.confirm(
        "Sei sicuro di voler rimuovere questo evento dal calendario?",
      )
    ) {
      return;
    }
            ...
            <div className="space-y-4 pt-4">
              <div className="flex flex-col space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    {calendarConfig.defaultPreferences.reminderTimes.map(
                      (option) => (
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {assignedUsers
                    .filter((user) =>
                      calendarState.selectedParticipants.includes(
                    ...
                    .map((user) => (
                      ...
                      >
                        ...
                        >
                          ...
                          {
                            calendarConfig.defaultPreferences.reminderTimes.find(
                              (t) => t.value === calendarState.reminderTime,
                            )?.label
                          }
                        </Badge>
                      </div>
