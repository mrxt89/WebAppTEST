...
function ItemAttachmentDetails({
  ...
  const handleSave = async () => {
    ...
    try {
      const result = await updateAttachment(attachment.AttachmentID, {
        description,
        isPublic,
        isVisible,
        isErpAttachment,
    ...
    return (
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 2, mt: 2 }}>
          <Button startIcon={<ViewIcon />} onClick={handleViewFile}>
            Visualizza
          </Button>
      ...
      <>
        ...
        <List disablePadding>
          <ListItem>
            ...
            <ListItemText primary="Nome file" secondary={attachment.FileName} />
          </ListItem>
          ...
          <ListItem>
            ...
            <ListItemText
              ...
              secondary={
                attachment.IsPublic
                  ? "Pubblico (visibile a tutte le aziende)"
                  : "Privato (visibile solo all'azienda proprietaria)"
              }
            />
          </ListItem>
          <Divider component="li" />
          ...
          <ListItem>
            ...
            <ListItemText
              primary="Stato"
              secondary={
                attachment.IsVisible ? "Visibile" : "Nascosto (soft delete)"
              }
            />
          </ListItem>
  ...
  const renderEditTab = () => (
    <Box>
      ...
      {!canEdit && (
        <Alert severity="warning" sx={{ mb: 2 }}>
          Non hai i permessi per modificare questo allegato. Solo gli utenti
          dell'azienda proprietaria possono modificarlo.
        </Alert>
      )}
        ...
        <DialogTitle>
          ...
          >
            <Typography variant="h6" noWrap>
              {tabValue === 0 ? "Dettagli allegato" : "Modifica allegato"}:{" "}
              {attachment?.FileName}
            </Typography>
