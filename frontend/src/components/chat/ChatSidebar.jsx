                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">
                          {Math.round((attachment.FileSizeKB / 1024) * 100) /
                            100}{" "}
                          MB
                        </p>
                      </div>
                        ...
                        onClick={async () => {
                          try {
                            ...
                            try {
                              ...
                              console.error(
                                "Errore durante lo scollegamento:",
                                error,
                              );
                              swal.fire({
                                title: "Errore",
                                text:
                                  error.message ||
                                  "Impossibile scollegare il documento",
                                icon: "error",
                              });
                            }
                          } catch (error) {
      ...
      case "highlights":
        ...
        return (
          <div className="px-2 py-4 h-full flex flex-col">
            <div className="flex items-center justify-between mb-3 px-2">
              <h3 className="text-sm font-medium">
                Consigli ({notificationHighlights.length})
              </h3>
                  ...
                  >
                    <div className="flex justify-between items-start mb-1">
                      <button
                        ...
                        onClick={() =>
                          handleRemoveHighlight(highlight.HighlightID)
                        }
                      >
                        <X className="h-3 w-3" />
                      </button>
          ...
          >
            ...
            <div className="flex border-b border-gray-200 bg-white">
              ...
              <button
                ...
                style={{
                  color:
                    activeTab === "attachments" ? categoryColor : undefined,
                }}
              >
