    ...
    >
      ...
      <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
        ...
        <div className="text-xs text-gray-500 mt-1">
          Creato da {pollData.CreatedByName} • {pollData.TotalVoters || 0}{" "}
          {pollData.TotalVoters === 1 ? "votante" : "votanti"}
          {pollData.AllowMultipleAnswers && (
            <span> • Risposte multiple consentite</span>
          )}
        </div>
      </div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mb-1 text-dark">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: option.UserVoted
                          ? "#10b981"
                          : "#3b82f6",
                      }}
                    ></div>
