        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 pt-2 border-t border-gray-200">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="multiple-answers" className="ml-2 block text-sm text-gray-700">
            ...
            <div>
              <label htmlFor="expiration-date" className="flex items-center text-sm text-gray-700 mb-1">
          ...
          <div className="px-4 py-3 bg-gray-50 rounded-lg flex items-start">
            ...
            <div className="text-sm text-gray-600">
              <p>Una volta creato, il sondaggio sarà visibile a tutti i partecipanti della chat.</p>
              <p className="mt-1">Solo tu potrai chiudere il sondaggio in qualsiasi momento.</p>
            </div>
          </div>
