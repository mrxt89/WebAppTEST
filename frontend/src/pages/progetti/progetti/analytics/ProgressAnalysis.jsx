    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-sm text-blue-600 mt-1">
                {tasks.filter((t) => t.Status === "COMPLETATA").length} di{" "}
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-sm text-red-600 mt-1">
                {tasks.length > 0
                  ? Math.round((delayedTasks.length / tasks.length) * 100)
                  : 0}
                % del totale
              </div>
            </div>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-sm text-green-600 mt-1">attività</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100">
          <CardContent className="pt-6">
            <div className="text-center">
              <h4 className="text-yellow-700 mb-2 font-medium">
                In Esecuzione
              </h4>
              <div className="text-3xl font-bold text-yellow-600">
                {tasks.filter((t) => t.Status === "IN ESECUZIONE").length}
              </div>
              <div className="text-sm text-yellow-600 mt-1">attività</div>
            </div>
          </CardContent>
        </Card>
      </div>
