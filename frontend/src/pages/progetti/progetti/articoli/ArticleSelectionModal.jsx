...
const ArticleSelectionModal = ({
  ...
  const { getAvailableItems, getERPItems, getBOMByItemId, loading } =
  ...
  useEffect(() => {
    ...
    const filteredDef = definedItems.filter(
      (item) =>
        item.Item.toLowerCase().includes(searchLower) ||
        (item.Description &&
          item.Description.toLowerCase().includes(searchLower)),
  ...
  const temporaryTotalPages = Math.ceil(
    temporaryFiltered.length / itemsPerPage,
  );
  ...
  const paginatedTempItems = getPaginatedItems(
    temporaryFiltered,
    currentTempPage,
  );
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center w-full">
          ...
          <div className="grid gap-1.5 leading-none">
            ...
            <p className="text-sm text-muted-foreground">
              Seleziona questa opzione se desideri importare anche la distinta
              base dell'articolo selezionato
            </p>
          </div>
        </div>
        ...
        {importBOM && (
          ...
          >
            ...
            <div className="grid gap-1.5 leading-none">
              ...
              <p className="text-sm text-muted-foreground">
                Seleziona questa opzione per importare l'intera struttura della
                distinta base, inclusi tutti i livelli e componenti
              </p>
            </div>
          </div>
        )}
        ...
        >
          ...
          >
            ...
            <div className="mt-2 text-sm text-gray-500">
              Gli articoli dal gestionale sono già definiti e verranno importati
              come articoli temporanei.
              {definedFiltered.length > 0 && (
                <span className="ml-2 text-blue-600">
