    ...
    <div className="h-full flex flex-col">
      ...
      <div className="border-b p-2 space-y-2 bg-gray-50">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent side="right" className="max-w-xs">
                  <p className="text-xs">
                    Queste opzioni controllano il comportamento quando trascini un componente dalla lista di riferimento 
                    sulla struttura della distinta base.
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
        ...
        <div className="bg-blue-50 rounded p-2 text-xs text-blue-700">
          ...
          <p>• <strong>Area sinistra</strong>: Sostituisci il componente</p>
          <p>• <strong>Area destra</strong>: Aggiungi sotto al componente</p>
        </div>
        ...
        {activeItem && (
          <div className="px-2 py-2 bg-blue-50 rounded text-xs text-blue-700 mt-1">
            ...
            <p>Stai trascinando: {activeItem.data?.BOM || activeItem.data?.ItemCode || 'Componente'}</p>
          </div>
        )}
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        <div className="border-b px-4">
          <TabsList className="w-full">
            <TabsTrigger value="erp" className="flex-1 flex items-center justify-center">
              <Database className="h-4 w-4 mr-2" />
              ERP
            </TabsTrigger>
            <TabsTrigger value="projects" className="flex-1 flex items-center justify-center">
              <Folder className="h-4 w-4 mr-2" />
              Progetti
            </TabsTrigger>
            <TabsTrigger value="reference" className="flex-1 flex items-center justify-center">
        ...
        <TabsContent value="projects" className="flex-1 p-0 m-0 overflow-hidden">
          <ProjectBOMs importOptions={importOptions} />
        </TabsContent>
        
        <TabsContent value="reference" className="flex-1 p-0 m-0 overflow-hidden">
