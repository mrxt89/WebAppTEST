...
const TabDocuments = () => {
  ...
  const itemCode = isFromERP ? targetItem?.Item || targetItem?.ComponentItemCode : null;
  const projectItemId = !isFromERP ? targetItem?.Id || targetItem?.ComponentId : null;
        ...
        <TabsContent value="bom" className="flex-1 p-0 m-0 overflow-auto">
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center p-8 max-w-md">
              ...
              <h3 className="text-lg font-medium mb-2">Allegati della Distinta Base</h3>
              <p className="text-sm text-gray-500">
                Gli allegati associati direttamente alla distinta base non sono ancora supportati in questa versione. 
                Saranno implementati in un futuro aggiornamento.
              </p>
            </div>
          </div>
        </TabsContent>
