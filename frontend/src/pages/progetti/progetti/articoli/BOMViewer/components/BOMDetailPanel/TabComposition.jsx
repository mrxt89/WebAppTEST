...
const TabComposition = () => {
  ...
  const handleAddComponent = async () => {
    ...
    if (selectedNode.data.stato_erp == '1') {
      toast({
        ...
        description: "Non è possibile aggiungere componenti a una distinta Presente in Mago",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      if (selectedNode.type === 'component') {
        ...
        if (parentBom && parentBom.stato_erp == '1') {
          toast({
            title: "Operazione non consentita",
            description: "Non è possibile eliminare componenti di una distinta Presente in Mago",
            variant: "destructive"
          });
  ...
  const handleAddComponentUnder = () => {
    ...
    if (selectedNode.data.bomStato_erp == '1') {
      toast({
        title: "Operazione non consentita",
        description: "Non è possibile aggiungere componenti sotto a un componente Presente in Mago",
        variant: "destructive"
      });
      return;
    }
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-10">
        <p className="text-gray-500">
          Seleziona un componente o un ciclo dalla struttura per visualizzarne i dettagli
        </p>
      </div>
    );
  }
    ...
    <div className="p-4">
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="py-4">
            <p>
              Sei sicuro di voler eliminare {selectedNode.type === 'component' ? 'questo componente' : 'questa fase'}?
              {selectedNode.type === 'component' && selectedNode.children?.length > 0 && (
                <span className="text-destructive font-medium block mt-2">
                  Attenzione: questo componente ha {selectedNode.children.length} {selectedNode.children.length === 1 ? 'ciclo' : 'cicli'} associati che verranno eliminati.
                </span>
              )}
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setManualCodeData({...manualCodeData, code: e.target.value})}
              ...
              <div className="col-span-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setManualCodeData({...manualCodeData, description: e.target.value})}
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setManualCodeData({...manualCodeData, nature: value})}
                >
              ...
              <div>
                ...
                <Input 
                  ...
                  onChange={(e) => setManualCodeData({...manualCodeData, uom: e.target.value})}
                  placeholder="PZ"
                />
              </div>
              ...
              <div className="col-span-2 flex items-center space-x-2 pt-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => setManualCodeData({...manualCodeData, copyBOM: checked})}
      ...
      >
        <DialogContent className="sm:max-w-[500px]">
          ...
          <DialogFooter>
            ...
            <Button 
              onClick={handleReplaceWithTemporary}
            >
              Sostituisci
            </Button>
          </DialogFooter>
      ...
      >
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Inserisci nuovo componente da aggiungere sotto</DialogTitle>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setAddUnderManualData({...addUnderManualData, code: e.target.value})}
                  placeholder="Inserisci un codice univoco"
                />
              </div>
              ...
              <div className="col-span-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setAddUnderManualData({...addUnderManualData, description: e.target.value})}
                  placeholder="Descrizione del nuovo articolo"
                />
              </div>
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setAddUnderManualData({...addUnderManualData, nature: value})}
                >
              ...
              <div>
                ...
                <Input 
                  ...
                  onChange={(e) => setAddUnderManualData({...addUnderManualData, uom: e.target.value})}
                  placeholder="PZ"
                />
              </div>
              ...
              <div>
                ...
                <Input 
                  ...
                  onChange={(e) => setAddUnderManualData({...addUnderManualData, quantity: parseFloat(e.target.value) || 1})}
                  placeholder="1"
                />
              </div>
            </div>
          ...
          <DialogFooter>
            ...
            <Button 
              onClick={handleAddUnderWithManual}
            >
              Aggiungi sotto
            </Button>
          </DialogFooter>
