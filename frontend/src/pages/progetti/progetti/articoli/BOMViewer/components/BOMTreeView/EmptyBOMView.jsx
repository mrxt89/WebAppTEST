    ...
    >
      ...
      {editMode && (
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-start gap-2 mt-2 text-blue-600 bg-blue-50 p-4 rounded">
            ...
            <p className="text-sm">
              <span className="font-medium">Suggerimento:</span> Puoi anche trascinare un componente 
              dal pannello di riferimento sulla destra e rilasciarlo qui per aggiungerlo come radice della distinta.
            </p>
          </div>
        </div>
      )}
      ...
      {isItemInERP && (
        <div className="flex items-start gap-2 mt-4 text-amber-700 bg-amber-50 p-4 rounded">
          ...
          <p className="text-sm">
            <span className="font-medium">Nota:</span> Questo articolo è presente in Mago e 
            la sua distinta non può essere modificata in questo sistema.
          </p>
        </div>
      )}
    </div>
