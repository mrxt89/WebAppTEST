...
export const createBOMEditorHook = (dependencies) => {
  const { selectedBomId, setLoading, addUpdateBOM, loadBOMData, toast } =
    dependencies;
    ...
    async (line, componentData) => {
      ...
      try {
        ...
        toast({
          title: "Error",
          description:
            error.message || "An error occurred while updating the component",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
    ...
    async (line) => {
      ...
      try {
        ...
        toast({
          title: "Error",
          description:
            error.message || "An error occurred while deleting the component",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
    ...
    async (routingData) => {
      ...
      try {
        ...
        toast({
          title: "Error",
          description:
            error.message || "An error occurred while adding the routing step",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
    ...
    async (rtgStep, routingData) => {
      ...
      try {
        ...
        toast({
          ...
          description:
            error.message ||
            "An error occurred while updating the routing step",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
    ...
    async (rtgStep) => {
      ...
      try {
        ...
        toast({
          ...
          description:
            error.message ||
            "An error occurred while deleting the routing step",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
