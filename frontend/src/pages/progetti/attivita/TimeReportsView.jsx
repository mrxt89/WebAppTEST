...
const TimeReportsView = ({ currentUserId, isAdmin = false, users = [] }) => {
  ...
  const loadReportData = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Errore durante il caricamento dei dati: ${response.statusText}`,
        );
      }
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center h-64 bg-white rounded-md border shadow">
          ...
          <p className="text-sm text-gray-400 mt-1">
            Prova a selezionare un periodo differente
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-end justify-between">
                  ...
                  <div className="text-sm text-blue-500">
                    ...
                    reportData.summary.TargetHours > 0
            ...
            <Card className="bg-amber-50">
              <CardContent className="p-6">
                ...
                <div className="flex items-end justify-between">
                  <div className="text-2xl font-bold">
                    {reportData.summary.Efficiency.toFixed(0)}%
                  </div>
                ...
                <div className="text-xs text-amber-500 mt-2">
                  Basato sul target di{" "}
                  {reportData.summary.TargetHours.toFixed(1)}h
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-purple-50">
              <CardContent className="p-6">
                ...
                <div className="flex items-end justify-between">
                  <div className="text-2xl font-bold">
                    {reportData.summary.AverageDaily.toFixed(1)}h
                  </div>
              ...
              <Card>
                ...
                <CardContent className="pt-0">
                  <div className="h-[300px]">
                    {reportData.projectDistribution &&
                    reportData.projectDistribution.length > 0 ? (
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                            ...
                            nameKey="ProjectName"
                          >
                            {reportData.projectDistribution.map(
                              (entry, index) => (
                                <Cell
                                  key={`cell-${index}`}
                          ...
                          <Tooltip
                            formatter={(value) => [
                              `${value.toFixed(1)}h (${((value / reportData.summary.TotalHours) * 100).toFixed(1)}%)`,
                              "Ore",
                            ]}
                          />
                          <Legend />
              ...
              <Card>
                ...
                <CardContent className="pt-0">
                  <div className="h-[300px]">
                    ...
                    reportData.dailyDistribution.length > 0 ? (
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart
          ...
          {viewMode === "details" && (
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">
                  Dettaglio attività per progetto
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {reportData.timeEntries.length > 0 ? (
                        ...
                        <tr>
                          ...
                          >
                            Nessuna registrazione disponibile per il periodo
                            selezionato
                          </td>
                        </tr>
                      )}
