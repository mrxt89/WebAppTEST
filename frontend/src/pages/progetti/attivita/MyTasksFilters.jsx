...
import { Search, RotateCcw, Calendar, ArrowUpDown, Users } from "lucide-react";
      ...
      <CardContent className="p-4 pt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-4">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            >
              <SelectTrigger
                className={filters.priority !== "all" ? "border-blue-500" : ""}
              >
          ...
          <div>
            ...
            >
              <SelectTrigger
                className={filters.dueDate !== "all" ? "border-blue-500" : ""}
              >
          ...
          <div>
            ...
            >
              <SelectTrigger
                className={filters.projectId !== "all" ? "border-blue-500" : ""}
              >
          ...
          {allUsers.length > 0 && (
            <div>
              ...
              >
                <SelectTrigger
                  className={filters.involvedUser ? "border-blue-500" : ""}
                >
