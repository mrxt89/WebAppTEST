...
const TasksStatistics = ({ tasks, isAdmin = false }) => {
  ...
  const statistics = useMemo(() => {
    ...
    const priorityDistribution = Object.entries(priorityCount).map(
      ([name, value]) => ({ name, value }),
    );
    ...
    const timelineDistribution = [
      ...
      {
        name: "Più avanti",
        value: totalTasks - completedTasks - delayedTasks - upcomingTasks,
      },
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-sm text-red-600 mt-1">
                {statistics.totalTasks > 0
                  ? Math.round(
                      (statistics.delayedTasks / statistics.totalTasks) * 100,
                    )
                  : 0}
                % del totale
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <h4 className="text-gray-700 mb-4 font-medium text-center">
              Distribuzione per Stato
            </h4>
