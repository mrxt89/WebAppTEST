...
const MyTasksList = ({ 
  ...
  const formatDaysToDeadline = (task) => {
    ...
    if (days < 0) {
      return <span className="text-red-500 font-medium">In ritardo di {Math.abs(days)} giorni</span>;
    }
    if (days === 0) {
    ...
    if (days <= 3) {
      return <span className="text-orange-500 font-medium">Scade tra {days} giorni</span>;
    }
                ...
                <div className="flex items-center">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start">
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'title', sortDirection: 'asc'})}>
                        A-Z
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'title', sortDirection: 'desc'})}>
                        Z-A
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
              ...
              <TableHead className="min-w-[150px]">
                <div className="flex items-center">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start">
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'project', sortDirection: 'asc'})}>
                        A-Z
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'project', sortDirection: 'desc'})}>
                        Z-A
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
              ...
              <TableHead className="w-[120px]">
                <div className="flex items-center">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start">
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'status', sortDirection: 'asc'})}>
                        A-Z
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'status', sortDirection: 'desc'})}>
                        Z-A
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
              ...
              <TableHead className="w-[120px]">
                <div className="flex items-center">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start">
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'priority', sortDirection: 'asc'})}>
                        Bassa-Alta
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'priority', sortDirection: 'desc'})}>
                        Alta-Bassa
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
              ...
              <TableHead className="min-w-[170px]">
                <div className="flex items-center">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start">
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'dueDate', sortDirection: 'asc'})}>
                        Prima in scadenza
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'dueDate', sortDirection: 'desc'})}>
                        Ultime in scadenza
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                  ...
                  <TableHead className="min-w-[150px]">
                    <div className="flex items-center">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="start">
                          <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'assignedTo', sortDirection: 'asc'})}>
                            A-Z
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => onFilterChange({...columnFilters, sortBy: 'assignedTo', sortDirection: 'desc'})}>
                            Z-A
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
              ...
              >
                <TableCell className="max-w-[300px]">
                  <div className="flex flex-col gap-1">
                    <div className="font-medium text-base line-clamp-2">{task.Title}</div>
                    {task.Description && (
                      <div className="text-gray-500 text-sm line-clamp-2">{task.Description}</div>
                    )}
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <div className="flex items-center gap-1">
                                  ...
                                  <span className="text-gray-600 text-sm">{getParticipants(task).length} partecipanti</span>
                                </div>
                              </TooltipTrigger>
                              <TooltipContent>
                                <div className="max-w-[200px]">
                                  <p className="font-medium mb-1">Partecipanti:</p>
                                  <ul className="text-xs">
                                    {getParticipants(task).map((participant, index) => (
                                      <li key={index}>
                ...
                <TableCell className="text-right">
                  <div className="flex items-center justify-end">
                    {task.Status !== 'COMPLETATA' && (checkAdminPermission({ AdminPermission: task.AdminPermission }) || isOwnTask(task)) && (
                      <Button
                        variant="outline"
                        size="sm"
                      ...
                      >
                        <CheckCircle2 className="h-4 w-4 mr-1" id = "completeTaskBtn"/>
                        Completa
                      </Button>
                    )}
                  </div>
