...
const ChangePassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${config.API_BASE_URL}/change-password`, {
        currentPassword,
        newPassword,
      }, {
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (!passwordRegex.test(e.target.value)) {
                    e.target.setCustomValidity('La password deve contenere almeno 8 caratteri, un numero, una lettera maiuscola e una minuscola');
                  } else {
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-2 border border-gray-300 rounded"
              />
              {newPasswordCheck !== newPassword && <p className="text-red-500">Le password non corrispondono</p>}
            </div>
            <button type="submit" className="w-full primaryButton p-2 rounded">Cambia Password</button>
          </form>
        </div>
