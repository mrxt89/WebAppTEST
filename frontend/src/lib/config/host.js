...
export const API_HTTPS_PORT = parseInt(import.meta.env.VITE_API_HTTPS_PORT || '3443');
export const API_HTTP_PORT = parseInt(import.meta.env.VITE_API_HTTP_PORT || '3001');
