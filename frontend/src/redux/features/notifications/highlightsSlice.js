    ...
    try {
      ...
      if (response.data && response.data.Success) {
        ...
        return rejectWithValue(
          response.data?.Message || "Failed to add highlight",
        );
      }
    } catch (error) {
  ...
  async ({ highlightId, notificationId }, { rejectWithValue, dispatch }) => {
    try {
      ...
      if (response.data && response.data.Success) {
        ...
        return rejectWithValue(
          response.data?.Message || "Failed to remove highlight",
        );
      }
    } catch (error) {
...
export const selectHighlightsLoading = (state) => state.highlights.loading;
