-- =====================================================
-- Script: Assegna permessi pagina Documentazione
-- Versione: 1.0
-- Data: 2025-10-23
...
SELECT @DocPageId = pageId FROM AR_Pages WHERE pageRoute = '/documentazione'

IF @DocPageId IS NULL
BEGIN
    PRINT 'ERRORE: Pagina Documentazione non trovata!'
    PRINT 'Esegui prima lo script 03_add_documentazione_page.sql'
    RETURN
END
...
WHERE p.pageRoute = '/documentazione'
